    ...
    <InfoInner style={{ color: 'black' }}>
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: '24px', margin: '0px', fontFamily: 'Montserrat' }}>Co-Founder, Strategy & Branding Lead</p>
        </div>
      </div>
      <Text style={{
      ...
      <Text style={{ fontSize: '20px', fontWeight: 'bold', margin: '0px' }}>There are two main reasons why we felt the need to create this app:</Text>
