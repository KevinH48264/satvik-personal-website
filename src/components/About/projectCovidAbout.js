...
const ProjectCovidAbout = () => (
  <InfoContainer style={{ backgroundColor: 'lightgreen' }}>
    <InfoInner style={{ color: 'black', fontFamily: 'helvetica-w01-roman,helvetica-w02-roman,helvetica-lt-w10-roman,sans-serif' }}>
      <div>
        {/* <img></img> */}
        <div>
          <p>Project Covid</p>
          <p>Founder, Strategy & Branding Lead</p>
        </div>
      </div>
      <Text style={{ fontSize: '24px', fontWeight: 'bold' }}>All the information and resources for coronavirus (COVID-19), easily accessible in one place.</Text>
      ...
      <Text style={{ fontSize: '24px', fontWeight: 'bold' }}>There are two main reasons why we felt the need to create this app:</Text>
