...
const About = () => (
  <InfoContainer>
    <InfoInner style={{ fontSize: '18px', lineHeight: '2em' }}>
      ...
      <p style={{ fontSize: '20px' }}>
        ...
        {' '}
        <b style={{ fontFamily: 'Helvetica Roman' }}>25 Under 25 Social Entrepreneurs</b>
        {' '}
        List by Impaction and Culture Media Co.. I have been recognized as
        {' '}
        <b style={{ fontFamily: 'Helvetica Roman' }}>1 of 8 Inspiring Mental Health Youth Activists</b>
        {' '}
        by Mashable, and
        {' '}
        <b style={{ fontFamily: 'Helvetica Roman' }}>1 of 15 Students Changing Collegiate Mental Health</b>
        {' '}
