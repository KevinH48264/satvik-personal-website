...
import {
  InfoContainer, InfoInner, Feature, FeatureHeading, FeatureText, FeatureLink, MobileFeaturesInfoInner,
} from './styles'
  ...
  <InfoContainer style={{ backgroundColor: '#DAEDFF' }}>
    <BrowserView>
      <InfoInner style={{ color: 'black' }}>
        <p style={{ color: '#1468A8', fontWeight: 'bold', fontSize: '44px' }}>Press Features</p>
    ...
    <MobileView>
      <MobileFeaturesInfoInner style={{ color: 'black' }}>
        <p style={{ color: '#1468A8', fontWeight: 'bold', fontSize: '44px' }}>Press Features</p>
